...
var require_ponyfill_es2018 = /* @__PURE__ */ require_index.__commonJSMin(((exports, module) => {
	/**
	* @license
...
var require_streams = /* @__PURE__ */ require_index.__commonJSMin((() => {
	/* c8 ignore start */
	var POOL_SIZE = 65536;
...
var init_fetch_blob = require_index.__esmMin((() => {
	require_streams();
	POOL_SIZE = 65536;
	_Blob = class Blob {
...
var _File, File;
var init_file = require_index.__esmMin((() => {
	init_fetch_blob();
...
var init_esm_min = require_index.__esmMin((() => {
	init_fetch_blob();
	init_file();
...
var require_node_domexception = /* @__PURE__ */ require_index.__commonJSMin(((exports, module) => {
...
var init_from = require_index.__esmMin((() => {
