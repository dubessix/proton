import { Et as RiStickyNoteLine, Ft as __commonJSMin, H as RiDeleteBinLine, It as __exportAll, Lt as __toESM, O as require_jsx_runtime, Pt as require_react, R as RiCloseLine, Y as RiFileTextLine, j as RiAddLine, q as RiEditLine, ut as RiMarkdownLine, yt as RiSave3Line } from "./index-RftkJ4Uw.js";
//#endregion
...
var MarkdownComponents = { code({ node, inline, className, children, ...props }) {
	return !inline ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "bg-black/50 rounded-lg p-3 my-2 border border-white/10 font-mono text-xs overflow-x-auto",
