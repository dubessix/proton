...
import { i as AnimatePresence, r as motion } from "./ui-motion-CfZG-Mah.js";
import { B as RiDownloadCloud2Line, Ct as RiSunLine, D as RiAddLine, Dt as RiUserVoiceLine, E as nets, Et as RiUserLine, F as RiCloudLine, L as RiCpuLine, Q as RiKey2Line, S as GiArtificialIntelligence, T as detectSingleFace, Tt as RiTerminalWindowLine, bt as RiShieldKeyholeLine, dt as RiPlugLine, ft as RiRecordCircleLine, gt as RiScan2Line, ht as RiSave3Line, j as RiBrainLine, mt as RiRocketLine, nt as RiLock2Line, pt as RiRefreshLine, rt as RiLockPasswordLine, st as RiMoonLine, w as useTheme, yt as RiSettings4Line } from "./index-DJ84wHMH.js";
...
var SettingsView = ({ isSystemActive }) => {
	...
	const cardClass = isDark ? "bg-[#0f0f13] border border-white/10 p-6 md:p-8 rounded-2xl flex flex-col gap-5 hover:border-white/20 transition-all shadow-lg" : "bg-white/55 border border-white/80 p-6 md:p-8 rounded-2xl flex flex-col gap-5 hover:border-white/30 transition-all shadow-sm";
	const inputContainerClass = isDark ? "flex items-center bg-[#050505] border border-white/10 rounded-lg px-4 py-3 focus-within:border-white/30 focus-within:bg-black transition-all duration-300 w-full" : "flex items-center bg-white/60 border border-black/10 rounded-lg px-4 py-3 focus-within:border-[#2ECC8F]/30 focus-within:bg-white transition-all duration-300 w-full";
	const titleClass = isDark ? "text-sm font-semibold text-white flex items-center gap-2" : "text-sm font-semibold text-[#1A1F1A] flex items-center gap-2";
