import { A as RiAddLine, D as require_jsx_runtime, Ft as __exportAll, It as __toESM, J as RiFileTextLine, K as RiEditLine, L as RiCloseLine, Nt as require_react, Pt as __commonJSMin, Tt as RiStickyNoteLine, V as RiDeleteBinLine, lt as RiMarkdownLine, vt as RiSave3Line } from "./index-Ccw-s9aW.js";
//#endregion
...
var MarkdownComponents = { code({ node, inline, className, children, ...props }) {
	return !inline ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "bg-white dark:bg-white/50 dark:bg-black/50 rounded-lg p-3 my-2 border border-slate-200 dark:border-white/10 font-mono text-xs overflow-x-auto",
...
var NotesView = ({ glassPanel }) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center justify-between pb-2 border-b border-slate-200 dark:border-white/10",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-2 text-[#1A1C1E] dark:text-zinc-100",
				...
				children: notes.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: `group p-3 rounded-xl border transition-all cursor-pointer flex items-center justify-between ${selectedNote?.filename === note.filename && !isEditorOpen ? "bg-emerald-500/10 border-emerald-500/30 shadow-[0_0_15px_rgba(16,185,129,0.1)]" : "bg-slate-100 dark:bg-zinc-900/40 border-slate-100 dark:border-white/5 hover:bg-white/5 hover:border-slate-200 dark:border-white/10"}`,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			className: `col-span-8 ${glassPanel || ""} bg-white dark:bg-white/40 dark:bg-black/40 backdrop-blur-xl border border-slate-100 dark:border-white/5 rounded-2xl flex flex-col overflow-hidden relative`,
			children: isEditorOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center justify-between mb-4 border-b border-slate-200 dark:border-white/10 pb-4",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							type: "text",
							placeholder: "ENTER NOTE TITLE...",
							value: newTitle,
							onChange: (e) => setNewTitle(e.target.value),
							className: "bg-transparent border-none outline-none text-lg font-bold [#1A1C1E] dark:text-white placeholder-zinc-500 w-full tracking-wider",
							autoFocus: true
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "flex gap-2",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: cancelEditor,
								className: "p-2 text-zinc-500 hover:[#1A1C1E] dark:text-white transition-colors",
				...
				className: "h-12 border-b border-slate-100 dark:border-white/5 flex items-center justify-between px-6 bg-white/5",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-[9px] font-mono text-zinc-400 bg-white dark:bg-black/20 px-2 py-1 rounded",
						children: "READ ONLY"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				className: "flex-1 overflow-y-auto p-8 scrollbar-small bg-white dark:bg-zinc-950/30",
