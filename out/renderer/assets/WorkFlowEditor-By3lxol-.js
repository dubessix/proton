...
import { n as require_react_dom } from "./vendor-z1GSqHGc.js";
import { r as require_jsx_runtime } from "./markdown-CQ9r_fel.js";
import { $ as RiKeyboardLine, C as createLucideIcon, D as RiAddLine, H as RiEditBoxLine, I as RiCodeLine, M as RiCheckLine, N as RiChromeLine, O as RiArrowDropDownLine, Ot as RiVolumeUpLine, P as RiCloseLine, R as RiDeleteBinLine, W as RiFileCopyLine, X as RiGlobalLine, Y as RiGamepadLine, _ as closeApp, _t as RiSearchLine, a as require_with_selector, at as RiMailLine, b as getMacroSequence, c as readEmails, ct as RiMore2Fill, d as clickOnCoordinate, et as RiLayoutColumnFill, f as scrollScreen, g as sendWhatsAppMessage, h as scheduleWhatsAppMessage, ht as RiSave3Line, i as color, j as RiBrainLine, l as sendEmail, lt as RiPhoneLine, m as takeScreenshot, n as number_default, o as clsx, p as setVolume, q as RiFlashlightLine, r as rgb_default, s as draftEmail, t as string_default, tt as RiLayoutColumnLine, u as runTerminal, ut as RiPlayFill, v as openApp, vt as RiServerLine, w as useTheme, wt as RiTerminalBoxLine, x as getAllApps, xt as RiSpotifyLine, y as performWebSearch, yt as RiSettings4Line, z as RiDiscordLine } from "./index-DJ84wHMH.js";
/**
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
				...
				children: isSidebarOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
						...
						children: tools.map((tool) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: `flex items-center gap-3 p-2 rounded-lg cursor-grab transition-all group ${isDark ? "bg-[#18181b] border border-[#27272a] hover:border-emerald-500/50 hover:bg-[#27272a]/50" : "bg-white/40 border border-black/10 hover:border-emerald-500/30 hover:bg-white/50"}`,
							draggable: true,
							onDragStart: (e) => e.dataTransfer.setData("application/reactflow", tool.name),
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: `p-1.5 rounded shadow-inner border ${isDark ? "bg-black border-white/5" : "bg-white/20 border-black/10"}`,
								children: getIcon(tool.name, 14)
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "flex flex-col",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: `text-[10px] font-bold tracking-widest uppercase group-hover:transition-colors ${isDark ? "text-zinc-300 group-hover:text-white" : "text-[#5A6B5A] group-hover:text-[#1A1F1A]"}`,
									children: tool.name.replace(/_/g, " ")
								})
							})]
						}, tool.name))
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				className: `absolute top-1/2 left-0 transform -translate-y-1/2 border border-l-0 p-2 rounded-r-lg z-50 transition-colors ${isDark ? "bg-[#111113] border-[#27272a] text-zinc-600 hover:text-emerald-500" : "bg-white/50 border-black/10 text-[#8FA08F] hover:text-emerald-500"}`,
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: resetCanvas,
								className: `p-3 rounded-lg border transition-colors cursor-pointer ${isDark ? "bg-[#18181b] border-[#27272a] text-zinc-600 hover:text-emerald-500 hover:border-emerald-500/50" : "bg-white/40 border-black/10 text-[#8FA08F] hover:text-emerald-500 hover:border-emerald-500/30"}`,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								...
								className: `px-4 py-2 rounded-lg text-sm outline-none font-bold tracking-wide w-64 shadow-inner border transition-colors ${isDark ? "bg-[#18181b] border-[#27272a] text-white focus:border-emerald-500" : "bg-white/50 border-black/10 text-[#1A1F1A] focus:border-emerald-500"}`
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								onClick: runMacroManually,
								className: `px-5 py-2 rounded-lg text-[11px] font-black tracking-widest transition-all flex items-center gap-2 cursor-pointer shadow-lg border ${isDark ? "bg-[#18181b] hover:bg-[#27272a] text-emerald-400 border-[#27272a] hover:border-emerald-500/50" : "bg-white/40 hover:bg-white/60 text-emerald-600 border-black/10 hover:border-emerald-500/30"}`,
