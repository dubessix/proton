...
const NotesView = ({ glassPanel: glassPanelProp }: { glassPanel?: string }) => {
      ...
      >
        {isEditorOpen ? (
          <div className="flex-1 flex flex-col p-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
            <div className={`flex items-center justify-between mb-4 border-b pb-4 ${isDark ? 'border-white/10' : 'border-black/10'}`}>
              <input
                type="text"
