...
export const themeClasses = {
  ...
  panel: 'bg-white dark:bg-[#0f0f13]',
  panelAlt: 'bg-slate-50 dark:bg-[#050505]',
  card: 'bg-white dark:bg-[#0f0f13] border border-slate-200 dark:border-white/10',
  overlay: 'bg-black/40 dark:bg-black/80 backdrop-blur-sm',
  modal: 'bg-white dark:bg-[#050505]',
  ...
  header: 'bg-slate-100 dark:bg-zinc-950/80 border-b border-slate-200 dark:border-white/5',
  headerText: 'text-[#1A1C1E] dark:text-white',
...
export const generateThemeClass = (lightClass: string, darkClass: string): string => {
